...
class DataGenerator:
    ...
    def generate(self):
        ...
        with open("generation/female_first_names.json", 'r') as f:
            female_first_names = json.loads(f.read())
        with open("generation/male_first_names.json", 'r') as f:
            male_first_names = json.loads(f.read())
        ...
        for i in range(self.generated_members):
            ...
            member = RockMember(username, password, name, gender, genre, instruments, collab, bio, teams)
        ...
        for i in range(self.generated_bands):
            ...
            looking_for = {'instruments': looking_for_instrument, 'genres': looking_for_genre,
                           'collaboration_types': looking_for_collab}
